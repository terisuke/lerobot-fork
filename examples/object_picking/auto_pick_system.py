...
class AutoPickSystem:
    ...
    def start_system(self):
        ...
        try:
            while self.is_running:
                ...
                moving_objects = self.tracker.get_moving_objects(self.velocity_threshold)
    ...
    def _attempt_pickup(self, obj):
        ...
        try:
            ...
            print(f"📍 Moving to position: ({robot_x:.3f}, {robot_y:.3f}, {robot_z:.3f})")
    ...
    def _display_results(self, rgb_image, tracked_objects, moving_objects):
        ...
        for obj in tracked_objects:
            ...
            if obj in moving_objects:
                ...
                cv2.putText(display_image, vel_text, (x, y + h + 20), 
                           cv2.FONT_HERSHEY_SIMPLEX, 0.4, color, 1)
        
        # Add system status
        status_text = f"Tracking: {len(tracked_objects)} | Moving: {len(moving_objects)}"
...
def main():
    ...
    parser.add_argument("--dataset-dir", default="./auto_pick_dataset",
