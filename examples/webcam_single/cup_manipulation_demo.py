...
class CupManipulationDemo:
    ...
    def __init__(self):
        ...
        self.target_classes = {"cup": 41, "bottle": 39, "vase": 75, "bowl": 46}
    ...
    def visualize_detections(self, frame, detections):
        ...
        for det in detections:
            ...
            cv2.putText(annotated, info, (x1, y2 + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 0), 1)
    ...
    def run_demo(self):
        ...
        while True:
            ...
            if len(cups) > 0:
                ...
                if grasp_planned:
                    cv2.putText(
                        annotated, "Grasp planned!", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2
                    )
                else:
