...
class ObjectDetector:
    ...
    def detect_objects(self, 
                      ...
                      intrinsics: rs.intrinsics) -> List[DetectedObject]:
        """
        ...
        if hasattr(self.model, 'predict'):
            ...
            for i in range(len(detections)):
                ...
                # Get depth at center
                depth_value = self._get_depth_at_point(depth_image, 
                                                    int(center_x), 
                                                    int(center_y))
                ...
                world_pos = self._depth_to_world_coords(center_x, center_y, 
                                                      depth_value, intrinsics)
    ...
    def _depth_to_world_coords(self, x: float, y: float, depth: float, 
